...
Furthermore, the used HPO-Framework may also affect the TWH, as some frameworks use resource allocation plans in combination with the **sampling** and **pruning** strategies to minimize idle resources.
